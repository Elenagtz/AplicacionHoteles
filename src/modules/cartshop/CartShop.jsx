  ...
  <View style={styles.row}>
    ...
    <View>
      ...
      <TouchableOpacity onPress={() => removeCartItem(item)}>
        <Icon type="material-community" name="delete" color="#000" size={24} />
      </TouchableOpacity>
    </View>
  </View>
);
  ...
  const calcularSubtotal = () => {
    ...
    cartItems.forEach((item) => {
      if (typeof item.precio === "number") {
        if (
          item.categoria &&
          (item.categoria.nombrecategoria === "Restaurante" ||
            item.categoria.nombrecategoria === "Miscelaneos")
        ) {
        ...
        case 1:
          response = (
            <View style={styles.row}>
              ...
              <Image
                source={{ uri: item.imagen_elemento }}
      ...
      <View style={styles.resumen}>
        ...
        <View style={{ flexDirection: "row" }}>
          ...
          <Text style={{ flexDirection: "row" }}>
            {" "}
            ${parseFloat((calcularSubtotal() * 0.16).toFixed(2))}
          </Text>
        </View>

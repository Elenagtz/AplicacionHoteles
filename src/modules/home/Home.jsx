  ...
  const handleCheckInDateChange = (event, selectedDate) => {
    ...
    if (selectedDate) {
      ...
      if (selectedDate < currentDate.setHours(0, 0, 0, 0)) {
        setErrorMessage(
          "La fecha de llegada debe ser posterior o igual a la fecha actual."
        );
      } else {
        setErrorMessage("");
      }
  ...
  const handleCheckOutDateChange = (event, selectedDate) => {
    ...
    if (selectedDate) {
      ...
      if (selectedDate <= checkInDate || selectedDate > maxCheckOutDate) {
        setErrorMessage(
          "La fecha de salida debe ser posterior a la fecha de llegada y dentro de los 7 días siguientes."
        );
      } else {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.imageContainer}>
        <Image source={Hotel} style={styles.image} resizeMode="cover" />
      </View>
      ...
      <View style={styles.reservationContainer}>
        ...
        <View style={styles.dateContainer}>
          <TouchableOpacity
            ...
            onPress={showCheckInDatePickerModal}
          >
            <Text>
              {checkInDate ? checkInDate.toLocaleDateString() : "Llegada"}
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.datePicker}
            onPress={showCheckOutDatePickerModal}
          >
            <Text>
              {checkOutDate ? checkOutDate.toLocaleDateString() : "Salida"}
            </Text>
          </TouchableOpacity>
      ...
      {isDatesSelected &&
        errorMessage === "" && ( // Nueva condición para mostrar el botón
          <TouchableOpacity
            style={styles.button}
      ...
      <View style={styles.textContainer}>
        ...
        <Text style={styles.description}>
          Somos un hotel familiar, ofrecemos los servicios de restaurante y spa,
          ven y conocénos, haz tu reservación.
        </Text>
      </View>
      <View style={styles.iconsContainer}>
        ...
        <TouchableOpacity
          style={[styles.textIcon, styles.cartButton]}
